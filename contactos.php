            ...
            <div class="col-md-6 pl-4 ">
                <div class=" bg-white rounded p-4 shadow mb-3">
                    ...
                    <form action="enviar_whatsapp.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="celular" class="text-lg">Celular:</label>
                                    <input type="text" id="celular" name="celular" required class="form-control mb-3" placeholder="Ingrese su número de celular">
                                </div>
...
<style>
    ...
    .header{
        ...
        url("happypeoplestore/dist/img/CONTACTOS.jpg");
        background-position: center bottom; /* Ajustar posición a la parte superior */
        background-repeat: no-repeat;
        background-size: 1%; /* Ajustar tamaño para cubrir completamente el contenedor */
        min-height: 60vh;
        display: flex;
        align-items: center;
