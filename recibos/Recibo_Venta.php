<?php
    ...
    // Recibo el idVenta del formulario POST
    ...
    $queryPV="SELECT id_venta,fecha_compra,fecha_confirmacion, total FROM ventas where id_venta='".$idVenta."';";
    $resQueryPV=mysqli_query($con, $queryPV);
    $rowPV=mysqli_fetch_assoc($resQueryPV);

    $IDVENTA= $rowPV['id_venta'];
    $FECHACOMPRA= $rowPV['fecha_compra'];
    $FECHAAPROBACION= $rowPV['fecha_confirmacion'];
    $TOTAL= $rowPV['total'];
  
    $queryDPV = "SELECT id_producto,cantidad, precio_unitario FROM detalle_venta where id_venta='".$idVenta."';";
            ...
            <div class="recibo bg-white">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $FECHAAPROBACION ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="datosRecibo">
                    <div class="info-cliente">
                        <p><strong>Codigo Compra: </strong><?php echo $idVenta ?></p>
                        ...
                        <p><strong>Estado de Compra: </strong>Aprobado</p>
                    </div>
                </div>
