<?php
    ...
    $queryPV="SELECT id_venta, id_cliente, fecha_compra,fecha_confirmacion, total FROM ventas where id_venta='".$idventa."';";
    ...
    $FECHAPROBADA= $rowPV['fecha_confirmacion'];
    $TOTAL= $rowPV['total'];
                                                        ...
                                                        <div class="recibo">
                                                            ...
                                                            <div class="datosRecibo">
                                                                <div class="info-cliente">
                                                                    <p><strong>Codigo Venta: </strong><?php echo $idventa ?></p>
