...
<head>
    ...
    <style>
        body {
            background-image: url('happypeoplestore/dist/img/registro.jpeg'); /* Cambia 'path/to/your/image.jpg' por la ruta de tu imagen de fondo */
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary boton" name="registro">Registrarse</button>
                            <a href="login.php" class="text-success float-right">Ir a Iniciar Sesión</a>
                        </div>
                    </div>
                </form>
